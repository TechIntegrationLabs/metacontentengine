...
import { Mail, Lock, Eye, EyeOff, Loader2, AlertCircle, Palmtree } from 'lucide-react';
...
const Login: React.FC<Props> = ({ onNavigate, onSuccess }) => {
  ...
  return (
    <div className="min-h-screen bg-void-950 flex items-center justify-center p-4">
      {/* Background effects - PCC brand colors */}
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-void-900/50 backdrop-blur-xl border border-white/5 rounded-2xl p-8 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  ...
                  className="text-xs text-pcc-teal hover:text-pcc-teal/80 transition-colors"
                >
                  Forgot password?
                </button>
              </div>
            ...
            {/* Submit Button - PCC coral/gold gradient */}
            <button
              type="submit"
              disabled={isLoading}
