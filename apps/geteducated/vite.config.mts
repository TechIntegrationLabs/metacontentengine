 ...
 * - To override for this app, create apps/geteducated/.env.local
 */
...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    cacheDir: '../../node_modules/.vite/apps/geteducated',
    ...
    define: {
      ...
      'import.meta.env.VITE_APP_NAME': JSON.stringify(env.VITE_APP_NAME || 'GetEducated'),
      'import.meta.env.VITE_APP_DESCRIPTION': JSON.stringify(env.VITE_APP_DESCRIPTION || 'AI-Powered Content Generation for Education'),
    },
  };
});
